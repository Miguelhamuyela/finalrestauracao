            ...
            <div class="card">
                <div class="card-body row">
                    ...
                    <div class="col-md-2 text-center">
                        <a href="<?php echo e(route('admin.coworks.create.index')); ?>" class="btn btn-primary">Cadastrar</a>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dataTable-1" class="table table-striped table-bordered mb-3">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $coworks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a href='<?php echo e(url("admin/cowork/show/{$item->id}")); ?>'
...
<?php echo $__env->make('layouts.merge.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Miguel.hamuyela\Desktop\finalrestauracao\resources\views/admin/coworks/list/index.blade.php ENDPATH**/ ?>