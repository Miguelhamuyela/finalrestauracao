...
<div class="form-row">
    <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" placeholder="Nome" id="name" name="name"
            value="<?php echo e(isset($user->name) ? $user->name : old('name')); ?>" required autofocus />
    </div>
    <div class="form-group col-md-4">
    ...
    <div class="form-group col-md-4">
        ...
        <select name="level" id="level" class="form-control" required>
            <?php if(isset($user->level)): ?>
                <option value="<?php echo e($user->level); ?>" class="text-primary h5" selected>
...
<?php /**PATH C:\Users\Miguel.hamuyela\Desktop\finalrestauracao\resources\views/forms/_formUser/index.blade.php ENDPATH**/ ?>