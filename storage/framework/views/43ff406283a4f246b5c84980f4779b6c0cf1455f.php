                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-2 col-md-6">
                            <div class="d-flex">
                                <div class="wrapper">
                                    <h3 class="mb-0 font-weight-semibold"><?php echo e($user); ?></h3>
                                    <a class="mb-0 font-weight-medium text-primary h5" href="<?php echo e(route('admin.user.index')); ?>">Utilizadores</a>
                                    <p class="mb-0 text-muted"><?php echo e($user/100); ?>%</p>
                                </div>
                        ...
                        <div class="col-lg-2 col-md-6 mt-md-0 mt-4">
                            <div class="d-flex">
                                <div class="wrapper">
                                    <h3 class="mb-0 font-weight-semibold"><?php echo e($startup); ?></h3>
                                    <a class="mb-0 font-weight-medium text-primary h5" href="<?php echo e(route('admin.startup.list.index')); ?>">Vistoria de Empresa</a>
                                    <p class="mb-0 text-muted"><?php echo e($startup/100); ?>%</p>
                                </div>
                                <div class="wrapper my-auto ml-auto ml-lg-2">
                        ...
                        <div class="col-lg-2 col-md-6 mt-md-0 mt-4">
                            <div class="d-flex">
                                <div class="wrapper">
                                    <h3 class="mb-0 font-weight-semibold"><?php echo e($employee); ?></h3>
                                    <a class="mb-0 font-weight-medium text-primary h5" href="<?php echo e(route('admin.employees.index')); ?>">Funcionários</a>
                                    <p class="mb-0 text-muted"><?php echo e($employee/100); ?>%</p>
                                </div>
                        ...
                        <div class="col-lg-2 col-md-6 mt-md-0 mt-4">
                            <div class="d-flex">
                                <div class="wrapper">
                                    <h3 class="mb-0 font-weight-semibold"><?php echo e($auditorium); ?></h3>
                                    <a class="mb-0 font-weight-medium text-primary h5" href="<?php echo e(route('admin.auditoriums.list.index')); ?>">Agenda de Vistoria</a>
                                    <p class="mb-0 text-muted"><?php echo e($auditorium/100); ?>%</p>
                                </div>
                                <div class="wrapper my-auto ml-auto ml-lg-4">
                        ...
                        <div class="col-lg-2 col-md-6 mt-md-0 mt-4">
                            <div class="d-flex">
                                ...
                                <div class="wrapper">
                                    ...
                                    <p class="mb-0 text-muted"><?php echo e($cowork/100); ?>%</p>
                                </div>
                                <div class="wrapper my-auto ml-auto ml-lg-2">
                        ...
                        <div class="col-lg-2 col-md-6 mt-md-0 mt-4">
                            <div class="d-flex">
                                <div class="wrapper">
                                    <h3 class="mb-0 font-weight-semibold"><?php echo e($client); ?></h3>
                                    <a class="mb-0 font-weight-medium text-primary h5" href="<?php echo e(route('admin.client.list.index')); ?>">Cadastro de Empresa</a>
                                    <p class="mb-0 text-muted"><?php echo e($client/100); ?>%</p>
                                </div>
                                <div class="wrapper my-auto ml-auto ml-lg-2">
                    ...
                    <div class="card">
                        <div class="card-body pb-0">
                            <div class="d-flex justify-content-between">
                                <a class="mb-0 font-weight-medium text-primary h5" href="<?php echo e(route('admin.elernings.list.index')); ?>">E-learning</a>
                                <p class="font-weight-semibold mb-0"><?php echo e($elearning/100); ?>%</p>
                            </div>
                            <h3 class="font-weight-medium mb-4"><?php echo e($elearning); ?></h3>
                        </div>
...
<?php echo $__env->make('layouts.merge.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Miguel.hamuyela\Desktop\finalrestauracao\resources\views/admin/home/index.blade.php ENDPATH**/ ?>