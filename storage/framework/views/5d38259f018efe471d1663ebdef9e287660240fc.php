...
<head>
    ...
    <title>INFOSI/Fatura de Pagamento-<?php echo e(date('d/m/Y', strtotime($lastUpdate))); ?></title>
...
<body style='height:auto; width:100%; background: url("dashboard/images/digital.canvas.png") no-repeat center;'>
    ...
    <header class="col-12 mt-2 row mb-5">
        ...
        <p class="text-right">
            Exmo.(s) Sr.(s) <br>
            <?php echo e($client); ?> <br>
            NIF: <?php echo e($nif); ?> <br>
    ...
    <section class="col-12 mb-5">
        <p class="text-center">
            <b>Fatura Nº </b><?php echo e($code); ?> |
            <b> Data:</b> <?php echo e(date('d/m/Y', strtotime($lastUpdate))); ?>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <tr class="text-center">
                    <td class="text-left"><?php echo e($nif); ?></td>
                    <td>AKZ</td>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <tr class="text-center">
                    <td class="text-left"><?php echo e($service); ?></td>
                    <td>UN</td>
        ...
        <div class="col-6 text-left">
            ...
            <table class="table table-striped">
                <tr>
                    ...
                    <td>
                        <h4 class="text-right"> <?php echo number_format($value, 2, ',', '.'); ?></h4>
                    </td>
                </tr>
...
<?php /**PATH C:\Users\Miguel.hamuyela\Desktop\finalrestauracao\resources\views/pdf/invoice/index.blade.php ENDPATH**/ ?>