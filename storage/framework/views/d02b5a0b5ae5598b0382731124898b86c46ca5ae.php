...
<body>
    ...
    <div class="container-scroller">
        ...
        <?php echo $__env->make('layouts._includes.dashboard.Navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- partial -->
        <div class="container-fluid page-body-wrapper">
<?php /**PATH C:\Users\Miguel.hamuyela\Desktop\finalrestauracao\resources\views/layouts/_includes/dashboard/Header.blade.php ENDPATH**/ ?>