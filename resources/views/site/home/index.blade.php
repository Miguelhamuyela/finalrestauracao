            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-12">
                    <div class="about-image-five">
                        ...
                        <img src="{{ url('site/assets/images/about/about-img1.jpg') }}" alt="about" />
                    </div>
                </div>
                <div class="col-lg-6 col-12">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="image">
                            <a href="javascript:void(0)"><img class="thumb" src="{{ url('site/assets/images/blog/1.jpg') }}"
                                    alt="Blog" /></a>
                            <div class="meta-details">
                                <img class="thumb" src="{{ url('site/assets/images/blog/b6.jpg') }}" alt="Author" />
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="image">
                            <a href="javascript:void(0)"><img class="thumb" src="{{ url('site/assets/images/blog/2.jpg') }}"
                                    alt="Blog" /></a>
                            <div class="meta-details">
                                <img class="thumb" src="{{ url('site/assets/images/blog/b6.jpg') }}" alt="Author" />
                                <span>BY TIM NORTON</span>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="image">
                            <a href="javascript:void(0)"><img class="thumb" src="{{ url('site/assets/images/blog/3.jpg') }}"
                                    alt="Blog" /></a>
                            <div class="meta-details">
                                <img class="thumb" src="{{ url('site/assets/images/blog/b6.jpg') }}" alt="Author" />
                                <span>BY TIM NORTON</span>
