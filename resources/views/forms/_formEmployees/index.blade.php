...
<div class="col-md-4">
    <div class="form-group">
        ...
        <select type="text" name="ministry" class="form-control border rounded" required>
            ...
            @isset ($employee->ministry)
                <option value="{{ $employee->ministry}}" class="text-white h6 bg-primary text-white" selected>
                    {{ $employee->ministry}}
...
<div class="col-md-3">
    <div class="form-group">
        ...
        <input type="text" name="teamLeader" id="teamLeader" value="{{ isset($employee->teamLeader) ? $employee->teamLeader : old('teamLeader') }}"
...
<div class="col-md-12">
    <div class="form-group">
        ...
        <input type="text" name="address" id="address" value="{{ isset($employee->address) ? $employee->address : old('address') }}"
