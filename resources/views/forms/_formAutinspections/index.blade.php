...
<div class="row">
        ...
        <div class="form-group">
            ...
            <select type="text" name="agreeInstallation" class="form-control border rounded" required>
                ...
                @isset($inspection->agreeInstallation)
                    <option value="{{ $inspection->agreeInstallation }}" class="text-white h6 bg-primary text-white"
                        selected>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" name="expatriateWork" id="expatriateWork"
                value="{{ isset($inspection->expatriateWork) ? $inspection->expatriateWork : old('expatriateWork') }}"
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" name="numberRoomm" id="numberRoomm"
                value="{{ isset($inspection->numberRoomm) ? $inspection->numberRoomm : old('numberRoomm') }}"
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" name="bedNumber" id="bedNumber"
                value="{{ isset($inspection->bedNumber) ? $inspection->bedNumber : old('bedNumber') }}"
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" name="tableNumber" id="tableNumber"
                value="{{ isset($inspection->tableNumber) ? $inspection->tableNumber : old('tableNumber') }}"
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select type="text" name="yearSelfinspection" id="yearSelfinspection"
                class="form-control border rounded" required>

                @if (isset($inspection->yearSelfinspection))
                    <option value="{{ $inspection->yearSelfinspection }}"
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select type="text" name="monthselfInspection" id="monthselfInspection"
                class="form-control border rounded" required>

                @if (isset($inspection->typestar))
                    <option value="{{ $inspection->monthselfInspection }}"
                        class="text-primary h6 bg-primary text-white" selected>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" name="workforce" id="workforce"
                value="{{ isset($inspection->workforce) ? $inspection->workforce : old('workforce') }}"
                class="form-control border rounded" placeholder="Nome do Chefe da Equipa " required>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" name="men" id="men"
                value="{{ isset($inspection->men) ? $inspection->men : old('men') }}"
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" name="women" id="women"
                value="{{ isset($inspection->women) ? $inspection->women : old('women') }}"
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            <label for="Detalhes Sobre a Empresa">Detalhes Sobre a Empresa <small class="text-danger"></small></label>
            <textarea class="form-control rounded" name="StartupDetails" required style="min-height:70px; min-width:100%">{{ isset($autinspection->StartupDetails) ? $autinspection->StartupDetails : old('StartupDetails') }}</textarea>
        </div>
    </div>
</div>
<!-- /.col -->
