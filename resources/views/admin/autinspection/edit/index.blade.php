...
@section('content')
    ...
    <div class="card shadow">
        <div class="card-body">
            <h3 class="my-2 text-center">Editar  {{$autinspection->name}} </h3>
            ...
            <div class="row align-items-center">
                ...
                <form class="col-lg-12 mt-2 col-md-12 col-12 mx-auto" enctype="multipart/form-data" method="POST" action="{{ route('admin.autinspection.update', $autinspection->id) }}">
                    @csrf
                    @method('PUT')
