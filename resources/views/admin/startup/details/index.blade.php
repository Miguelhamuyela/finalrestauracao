                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a target="_blank" class="dropdown-item "
                                        href="{{ url("admin/startup/print/{$startup->id}") }}"> <i
                                            class="fa fa-print fa-16 mr-2"></i> Imprimir</a>
                                    <a class="dropdown-item" href="{{ url("admin/documentos/create/{$startup->id}") }}"> <i
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    ...
                    <div class="row  align-items-center">
                        ...
                        @isset($startup->startupDocuments)
                        <div class="col-md-6">
                            <p class="text-dark">
                                <b>Documentação</b><br>
                                ...
                                @foreach ($startup->startupDocuments as $item)
                                    <small class="mr-3">
                                        <a target="_blank"
